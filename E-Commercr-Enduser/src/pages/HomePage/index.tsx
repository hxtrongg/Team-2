  ...
  return (
    <div>
      ...
      >
        <div className="container mx-auto px-4">
          <div className="flex flex-wrap -mx-3 ">
            <div className="w-full lg:w-1/2 px-3 mb-6 lg:mb-0">
              <div className="mb-6 h-56 w-full rounded-xl overflow-hidden  bg-slate-100 border">
                ...
                >
                  <SwiperSlide className="">
                    <img className="w-full h-full  rounded-xl" src="https://cdn.tgdd.vn/2023/11/banner/IP15-720-220-720x220-3.png" alt="Slide 1" />
                  </SwiperSlide>
                  <SwiperSlide>
                    <img
              ...
              <div className="relative h-56 w-full bg-cover bg-center bg-no-repeat rounded-xl">
                <Swiper
                  slidesPerView={1}
                  spaceBetween={30}
                  pagination={{
                ...
                >
                  ...
                  <SwiperSlide>
                    <img className="w-full h-full  rounded-xl" src="https://digizone.com.vn/wp-content/uploads/2023/06/fill-banner4.jpg" alt="Slide 2" />
                  </SwiperSlide>
                </Swiper>
              </div>
            </div>
        ...
        {/* homepage hotproduct sp có giảm giá */}
       <section className="bg-gray-100 border-t border-b py-6  my-6 rounded-md">
        <h2 className="pb-2 ml-8 text-xl font-bold text-left text-gray-800 md:text-3xl ">Hot Products</h2>
        ...
        >
          {queryProduct.data?.data.data.products.map((data: productDataType) => (
            data.salePrice && 
            <SwiperSlide className={styles.slide_a}>
              <div className="w-64  bg-white shadow-md rounded-xl duration-500 hover:scale-105 hover:shadow-xl">
                <a href="#">
                  <img src={data.thumbnail} alt="Product" className="h-80 w-64 object-cover rounded-t-xl" />
                  <div className="px-4 py-3 w-64">
                    ...
                    <div className="flex items-center">
                      ...
                      <del>
                        <p className="text-sm text-gray-600 cursor-auto ml-2">${data.salePrice}</p>
                      </del>
        ...
        {/* <div className="flex justify-center">
          <a
            href="#"
            className="px-4 py-2 mt-5 text-orange-500 border border-orange-500 rounded-full hover:text-gray-50 hover:bg-orange-500 dark:text-gray-400 dark:bg-gray-900 dark:border-gray-900 dark:hover:border-gray-700 dark:hover:bg-gray-700"
          >
            View More
          </a>
        </div> */}
        ...
        {/* category products */}
      <section className="bg-gray-100 border-t border-b py-6  my-6 rounded-md">
        <h2 className="pb-2 ml-8 text-xl font-bold text-left text-gray-800 md:text-3xl ">Products by category</h2>
        <div className="w-20 mb-6 ml-8 border-b border-red-700 dark:border-gray-400"></div>
        <Swiper
          slidesPerView={1}
          spaceBetween={20}
