...
const CustomerOrderDetail = () => {
  ...
  const getOrder = (id: string): Promise<IOderdetail>=>{
    return axios.get(config.urlAPI+'/v1/orders/id/'+id)
  }

  const {data: order, isLoading, isError, error} = useQuery<IOderdetail, Error>({ 
