...
const HomePage = () => {
    return (
        <div>
            ...
            <section data-section-id="1" data-share="" data-category="newest-products" data-component-id="4f76139a_01_awz" className="pt-12 bg-gray-100 overflow-x-hidden">
                <div className="container mx-auto px-4">

                    <div className="flex flex-wrap -mx-3 mb-20">
                        <div className="w-full lg:w-1/2 px-3 mb-6 lg:mb-0">
                            <div className="relative mb-6 h-64 w-full bg-cover bg-center bg-no-repeat" style={{ backgroundImage: `url('https://shuffle.dev/yofte-assets/images/placeholder-snapshot.png')` }} data-config-id="image1">
                                <span className="inline-block mt-4 ml-4 px-2 py-1 text-xs font-bold font-heading border-2 border-red-500 rounded-full text-red-500 bg-white" data-config-id="badge1">-10%</span>
                                <a className="absolute inset-0 flex items-end" href="#">
                                    <div className="pl-12 pb-12">
                                        <h3 className="text-3xl font-bold font-heading text-white" data-config-id="title1">LIFE Bottle 2.0</h3>
                                        <p className="text-xl text-white font-bold font-heading">
                                            <span data-config-id="price1">$10.30</span>
                                            <span className="text-sm font-normal line-through" data-config-id="price1-old">11.99</span>
                                        </p>
                                    </div>
                                </a>
                            </div>
                            <div className="relative h-64 w-full bg-cover bg-center bg-no-repeat" style={{ backgroundImage: `url('https://shuffle.dev/yofte-assets/images/placeholder-playing-tennis.png')` }}
                                data-config-id="image2">
                                <span className="inline-block mt-4 ml-4 px-2 py-1 text-xs font-bold font-heading border-2 border-red-500 rounded-full text-red-500 bg-white" data-config-id="badge2">-10%</span>
                                <a className="absolute inset-0 flex items-end" href="#">
                                    <div className="pl-12 pb-12">
                                        <h3 className="text-3xl font-bold font-heading text-white" data-config-id="title2">Tennis racket Sanks 2</h3>
                                        <p className="text-xl text-white font-bold font-heading">
                                            <span data-config-id="price2">$126.90</span>
                                            <span className="text-sm font-normal line-through" data-config-id="price2-old">$139.90</span>
                                        </p>
                                    </div>
                                </a>
                            </div>
                        ...
                        <div className="w-full lg:w-1/2 px-3">
                            <div className="relative inline-block mb-6 h-96 lg:h-full w-full bg-no-repeat bg-cover" style={{ backgroundImage: `url('https://shuffle.dev/yofte-assets/images/placeholder-bike.png')` }} data-config-id="image3">
                                <span className="inline-block px-2 py-1 ml-4 mt-4 text-xs font-bold font-heading border-2 border-blue-400 rounded-full text-blue-500 bg-white uppercase" data-config-id="badge3">New</span>
                                <div className="absolute bottom-0 left-0 pb-20 pl-12">
                                    <span className="text-xl text-orange-300 font-bold font-heading" data-config-id="label3">Excellent value bike</span>
                                    <h3 className="mt-3 mb-2 text-3xl font-bold font-heading text-white" data-config-id="title3">Brooklyn Sain 1</h3>
                                    <p className="mb-10 font-bold font-heading text-white" data-config-id="price3">$379.90</p>
                                    <a className="inline-block bg-orange-300 hover:bg-orange-400 text-white font-bold font-heading py-4 px-8 rounded-md uppercase transition duration-200" href="#" data-config-id="action">Buy</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <section className="flex items-center bg-gray-100 dark:bg-gray-800  py-8">
